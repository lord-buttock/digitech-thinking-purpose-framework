---
title: "Digital Technologies — Year 4"
type: curriculum-reference
tags: [curriculum, victorian-curriculum, year-4, digital-technologies]
source: "Victorian Curriculum F-10 Version 2.0 — Technologies (© VCAA, CC-BY-NC 3.0)"
band: "Levels 3 and 4"
updated: 2026-06-23
---
...
**VC2TDI4S02** — explore transmitting different types of data between digital systems
...
**VC2TDI4S03** — access their school account using a memorised password and explain why it should be easy to remember, but hard to guess
...
### Strand: Data, Information and Privacy

**VC2TDI4D01** — recognise different types of data and explore how the same data can be represented differently depending on the purpose
...
- explaining how the same data can be represented in different ways and why some representations are better than others in certain contexts, for example the variations of four, 4, IV, llll and quatre, and that numbers are better for calculation than words

**VC2TDI4D02** — collect, organise and present different types of data using software tools to create information and solve problems
...
**VC2TDI4D03** — use the core features of common digital tools to create, locate and communicate content, following agreed conventions for a diverse audience
...
**VC2TDI4D04** — use the core features of common digital tools to share content, plan tasks and collaborate, demonstrating agreed behaviours, supported by trusted adults
...
**VC2TDI4D05** — identify what personal data is stored and shared in their online accounts and discuss any associated risks
...
**VC2TDI4C01** — define simple problems with teacher-provided requirements
...
**VC2TDI4C02** — follow, describe and represent algorithms involving sequencing, comparison operators (branching) and iteration
...
**VC2TDI4C03** — design a simple user interface, generate, communicate and compare the designs
...
**VC2TDI4C04** — implement simple algorithms as visual programs involving control structures and input
...
- writing programs that make decisions involving comparison, for example comparing whether the temperature is above 25 °C to label the weather hot or cold

**VC2TDI4C05** — discuss how existing and student-created solutions satisfy the given requirements
