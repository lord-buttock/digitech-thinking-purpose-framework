---
title: "Digital Technologies — Year 5"
type: curriculum-reference
tags: [curriculum, victorian-curriculum, year-5, digital-technologies]
...
**VC2TDI6S01** — investigate the main internal components of common digital systems and their function
...
**VC2TDI6S02** — examine how digital systems form networks to transmit data
...
**VC2TDI6S03** — access multiple personal accounts using unique passphrases and explain the risks of password re-use
...
**VC2TDI6D01** — explain how digital systems represent all data using numbers and explore how data can be represented using binary
...
**VC2TDI6D02** — acquire and manipulate different types of data from a range of sources using software tools, including spreadsheets
...
**VC2TDI6D03** — analyse and visualise data using a range of software, including spreadsheets to create information and solve problems
...
**VC2TDI6D04** — select and use appropriate digital tools effectively to create, locate and communicate content, applying common conventions for a diverse audience
...
**VC2TDI6D05** — select and use appropriate digital tools effectively to share content online, plan tasks and collaborate on projects, demonstrating agreed behaviours, supported by trusted adults
...
**VC2TDI6D06** — explain the creation and permanence of their personal digital footprint and consider privacy when collecting personal data
...
**VC2TDI6C01** — define problems with teacher-provided or co-developed functional requirements
...
**VC2TDI6C02** — design and represent algorithms involving multiple alternatives (branching) and iteration
...
**VC2TDI6C03** — design and modify a user interface for a digital system, and generate, communicate and evaluate the designs
...
**VC2TDI6C04** — implement algorithms as visual programs involving control structures, variables and input
...
**VC2TDI6C05** — evaluate existing and student-created solutions against the requirements and their broader community impact
