---
title: "Digital Technologies — Foundation"
type: curriculum-reference
tags: [curriculum, victorian-curriculum, foundation, digital-technologies]
...
**VC2TDI2S01** — identify and explore digital systems including hardware and software components for a purpose
...
**VC2TDI2S02** — identify some data that is personal and access their school account with a recorded username and password
...
**VC2TDI2D01** — explore patterns in data and represent data as objects, pictures, symbols, numbers and words
...
**VC2TDI2D02** — explore and use the basic features of common digital tools to create, locate and communicate content for a diverse audience
...
**VC2TDI2D03** — explore and use the basic features of common digital tools to share content and collaborate, demonstrating agreed behaviours and supported by trusted adults
...
**VC2TDI2D04** — recognise and discuss that some websites and apps store their personal data online
...
**VC2TDI2C01** — investigate simple problems for known users that can be solved with digital systems
...
**VC2TDI2C02** — follow, describe and represent algorithms involving a sequence of steps, branching (decisions) and iteration (repetition) needed to solve simple problems
...
**VC2TDI2C03** — discuss how existing digital systems satisfy identified needs for known users
